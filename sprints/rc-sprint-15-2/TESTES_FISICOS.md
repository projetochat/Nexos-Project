...
- O banco `trixus_0801` usado no verify nao tinha connection Evolution.
- O banco `trixus` tinha connections Trixus `CONNECTED`, mas apontando para `externalReference` diferente da instancia Evolution `open`.
