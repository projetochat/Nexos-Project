...
- Migrado filas para agregador operacional por departamento.
- Removido simulador de conversa do runtime.
- Atualizados docs de API, arquitetura, fluxo, banco, componentes, auth, roadmap e changelog.
