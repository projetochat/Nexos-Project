...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'SUPERVISOR', 'OPERATOR');
...
CREATE TABLE "protected_records" (
    ...
    CONSTRAINT "protected_records_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "protected_records_tenantId_idx" ON "protected_records"("tenantId");
...
-- AddForeignKey
ALTER TABLE "protected_records" ADD CONSTRAINT "protected_records_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
